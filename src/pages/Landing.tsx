    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 bg-foreground text-background">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-6">Every Metric is a Stone</h2>
          <p className="text-lg leading-relaxed opacity-90">
            We believe business owners are the new architects of the future.
            Every insight is a beam. Together they build the decisions that shape tomorrow.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Your data, your rules—encrypted end‑to‑end with complete control 
                over who sees what and when.
              </p>
            </div>
            
            <div className="space-y-6">
              <h3 className="text-2xl font-bold">Low Complexity</h3>
              <p className="text-muted-foreground">
                Setup in minutes. No DevOps overhead. No technical expertise required 
                to get powerful insights.
              </p>
            </div>
            
            <div className="space-y-6">
              <h3 className="text-2xl font-bold">Local & Global</h3>
              <p className="text-muted-foreground">
                Hyperlocal insights with worldwide reach. Understand your market 
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Dashboards that drive change, not vanity. Every metric comes with 
